...
class ContentTrackContentVC: NSViewController {    
    
    private let trackContentOptions = ["SEARCH", "VIEW_ITEM", "VIEW_ITEMS", "RATE", "SHARE", "INITIATE_STREAM", "COMPLETE_STREAM"]
    ...
    private var searchQueryTextField: NSTextField!
    ...
    override func viewDidLoad() {
        ...
        eventDescriptionTextField = view3
        eventDescriptionTextField.placeholderString = "Event Description"
        
        let view4 = getTextField(targetVew: documentView)
        searchQueryTextField = view4
        searchQueryTextField.placeholderString = "Search Query"
    ...
    @IBAction func submitButtonAction(_ sender: Any) {
        ...
        event.customData["Custom_Event_Property_Key1"] = customDataTextField.stringValue
