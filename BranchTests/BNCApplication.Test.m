...
- (void)testApplication {
    ...
    // TODO: These only exist when integrated into a full app, make them part of an integration test
...
// TODO: unit tests should not be order dependent, refactor this test
...
//
//    NSDate *firstBuildDate = [keychain retrieveValueForService:kBranchKeychainService key:kBranchKeychainFirstBuildKey error:nil];
//    XCTAssertEqualObjects(application.firstInstallBuildDate, firstBuildDate);
//
//    NSDate *firstInstallDate = [keychain retrieveValueForService:kBranchKeychainService key:kBranchKeychainFirstInstalldKey error:nil];
